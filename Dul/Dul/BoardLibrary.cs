    ...
    public class BoardLibrary
    {
        ...
        public static string ShowCommentCount(object objCommentCount)
        {
            ...
            try
            {
                ...
                {
                    strTemp = "<img sr=\"/images/dnn/commentcount.gif\" />";
        ...
        public static string FuncFileDownSingle(int id, string strFileName, string strFileSize)
        {
            ...
            {
                return "<a href=\"/DotNEtNote/BoardDown.aspx?Id=" + id.ToString() + "\">" + DownloadType(strFileName, strFileName + "(" + ConvertToFileSize(Convert.ToInt32(strFileSize)) + ")")
                    + "</a>";
            }
            else
            {
        ...
        public static string DownloadType(string strFileName, string altString)
        {
            ...
            switch(strFileExt)
            {
                ...
                default:
                    r = "<img src='/images/ext/ext_unkenown.gif' border='0' alt='" + altString + "'>"; break;
