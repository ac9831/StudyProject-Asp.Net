<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmValidationControl.aspx.cs" Inherits="WebApplication1.FrmValidationControl" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ol>
                ...
                <li>
                    Global.asax - Application_Start(): <br />
