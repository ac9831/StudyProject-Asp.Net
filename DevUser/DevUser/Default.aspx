    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:LoginView ID="LoginView1" runat="server">
                <AnonymousTemplate>
                    <asp:LoginStatus ID="LoginStatus1" runat="server" LoginText="로그인" /> | <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Register.aspx">회원가입</asp:HyperLink>
                </AnonymousTemplate>
                <LoggedInTemplate>
