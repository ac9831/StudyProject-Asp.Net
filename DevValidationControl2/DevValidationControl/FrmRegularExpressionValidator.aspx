<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmRegularExpressionValidator.aspx.cs" Inherits="WebApplication1.ㄹ귺ㄷ혀ㅣㅁㄱㄸ텍ㄷㄴ냐ㅐㅜㅍ미ㅑㅇㅁ색" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RegularExpressionValidator ID="valHomePage" runat="server" ErrorMessage="홈페이지를 정확히 입력하시오."
                ControlToValidate="txtHomePage" ValidationExpression="http(s)?://([\w-]+\.)+[\w-]+(/[\w- ./?%&=]*)?"></asp:RegularExpressionValidator>
            <hr />
