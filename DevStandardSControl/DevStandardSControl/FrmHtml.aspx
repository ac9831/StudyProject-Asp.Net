<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmHtml.aspx.cs" Inherits="DevStandardSControl.FrmHtml" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Image ID="imgHome" runat="server" ImageUrl="./images/btn_home.gif"
                ToolTip="홈으로..."
            ...
            <asp:ImageMap ID="mapHome" runat="server" ImageUrl="./images/btn_home.gif">
                <asp:RectangleHotSpot AlternateText="태오닷넷" Bottom="5" HotSpotMode="Navigate" NavigateUrl="http://taeyo.net"
                    Right="5" Target="_blank" />
                <asp:CircleHotSpot AlternateText="닷넷코리아" HotSpotMode="Navigate" NavigateUrl="http://www.dotnetkorea.com/"
