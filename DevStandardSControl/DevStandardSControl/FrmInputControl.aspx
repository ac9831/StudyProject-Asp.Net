<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmInputControl.aspx.cs" Inherits="DevStandardSControl.FrmInputControl" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="width: 500px">
                ...
                <tr>
                    <td style="width: 200px;">체크리스트(취미)</td>
                    <td style="width: 100px;">
                        <asp:CheckBoxList ID="lstHobby" runat="server" RepeatColumns="2" RepeatDirection="Horizontal"
                            RepeatLayout="Flow" Width="202px" >
                            <asp:ListItem Selected="True" Value="5">축구</asp:ListItem>
