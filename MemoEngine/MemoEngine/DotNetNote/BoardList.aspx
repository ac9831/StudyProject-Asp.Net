    ...
    <table style="width: 700px; margin-left: auto; margin-right: auto;">
        <tr>
            <td>
                ...
                <asp:GridView ID="ctlBoardList" runat="server" AutoGenerateColumns="false" DataKeyNames="Id" CssClass="table table-bordered table-hover table-condensed table-striped table-responsive">
                    <Columns>
