...
<table style="width:600px; border-collapse: collapse;padding: 5px; margin-left:auto; margin-right:auto;">
    ...
    <tr>
        ...
        <td style="width:500px;">
            ...
            <asp:RequiredFieldValidator ID="valName" runat="server" ErrorMessage="* 이름을 작성해 주세요." ControlToValidate="txtName" Display="None"
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RegularExpressionValidator ID="valEmail" runat="server" ErrorMessage="* 메일 형식이 올바르지 않습니다." ControlToValidate="txtEmail" Display="None"
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="valTitle" runat="server" ErrorMessage="* 제목을 기입해 주시요." ControlToValidate="txtTitle" Display="None"
                SetFocusOnError="true"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <apsn style="color:#aaaaaa;font-style:italic">(Optional)</apsn>
            <br />
    ...
    <tr>
        <td style="text-align:right;">
            <apsn style="color: #ff0000;">*</apsn>인코딩
        </td>
        <td>
